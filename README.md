...
- DevOps / Tools: Docker, GitHub Actions, CI/CD, AWS (Lambda, S3)
- Testing & Quality: Jest, React Testing Library, pytest, ESLint, Prettier

What I'm Working On
- Improving developer workflows with automation and tooling.
...
- If you have an idea or a role that might be a good fit, feel free to reach out.

Fun / Misc
- Coffee lover ☕ • Avid reader 📚 • I enjoy solving interesting engineering problems.

Thank you for visiting — let's build something great together!
<!-- Tip: Replace placeholders (website, email, socials, project links, and descriptions) with your real details. -->
